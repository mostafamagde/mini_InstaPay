...
class OnBoardingCubit extends Cubit<OnBoardingState> {
  ...
  final Map<String, dynamic> onBoardingScreens = {
    ...
    'thirdScreen': {'img': 'assets/images/IMG_20241213_215740.jpg', 'title': 'Financial Services', 'subtitle': 'You can now check your transactions history and balance through Instapay.'},
    'fourthScreen': {
